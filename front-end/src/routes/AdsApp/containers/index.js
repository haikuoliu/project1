              ...
              <Col span={16}>
                <Menu
                  ...
                  <Menu.Item key="ads_list">
                    <Link to="/ads/ads_list"><Icon type="appstore" />Advertisemnts</Link>
                  </Menu.Item>
                  <Menu.Item key="user_sets">
                    <Link to="/ads/user_sets"><Icon type="mail" />User Sets</Link>
                  </Menu.Item>
                  <Menu.Item key="push">
                    <Link to="/ads/push"><Icon type="cloud-upload" />Push</Link>
                  </Menu.Item>
                </Menu>
              </Col>
              <Col span={4} className="full-height">
...
function mapState(state) {
  return {
    ...
    sponsorInfo: state.ads.get('sponsor').toJS()
  }
}
